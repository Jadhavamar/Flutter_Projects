...
import 'package:music_app/view/seemore.dart';
import 'package:music_app/view/player_display.dart';

class Displaygallery extends StatefulWidget {
  const Displaygallery({super.key});
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemCount: Provider.of<SongController>(context).discog.length,
                ),
              ),
            ),
            const Positioned(
                  ...
                  child: SingleChildScrollView(
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount: Provider.of<SongController>(context)
                            .songList
                            .length,
                        itemBuilder: (context, index) {
                          return GestureDetector(
